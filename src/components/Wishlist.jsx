...
const Wishlist = () => {
  const { wishlistBooks: books } = useOutletContext();
              ...
              <div className="hero-content justify-start flex-col lg:flex-row gap-6 p-6">
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <div>
                      <p className="space-x-3">
                        ...
                        {book.tags.map((tag) => (
                          <span
                            className="text-[#23BE0A] bg-[#23BE0A0D] rounded-[30px] px-4 py-2"
                            key={tag}
                          >
                            #{tag}
                          </span>
                  ...
                  <div className="flex gap-3">
                    ...
                    <Link
                      to={`/book/${book.bookId}`}
                      className="bg-[#23BE0A] text-[#FFFFFF] font-medium px-5 py-3 rounded-[30px]"
                    >
